...
last_modified_at: 2023-08-01 21:20:19 +0800
mermaid: true
tags:
- qemu
title: FEMU 代码分析
...
$\text{BW}=min(\frac{\text{pg\_size}}{\text{pg\_rd\_lat}}\times\text{luns\_per\_ch}, \frac{\text{pg\_size}}{\text{ch\_xfer\_lat}})\times\text{nchs}$
